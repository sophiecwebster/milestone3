...
To answer these questions, I will work with the message data and HUDS' seasonal menus, which I will import and clean as an excel file (I have done so with the Winter 2020 file and will add the others once I gain access to them). For daily specifics, I may also scrape the menu from the HUDS website, though I have not yet decided if that will be necessary. Moreover, to answer the last question listed above, I may opt to survey students opinions of the interface and their usage thereof.
