...
To answer these questions, I will work with the message data and hope to use HUDS' menus, which I can either scrape from their website or import and clean excel files that Crista has access to. Moreover, to answer the last question, I may opt to survey students opinions of the interface and their usage thereof.
